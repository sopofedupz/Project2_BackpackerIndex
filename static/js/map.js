...
d3.json(linkCoords, (function(error, jsonData1) {
  ...
  d3.json(linkFacts, (function(error, jsonData2) {
    ...
    for ( var i=0; i < jsonData1.length; ++i ) {
      ...
      newMarker.bindPopup("<b>" + "Destination:  "  + factsData[0].city_country  + "</b>"  + "<br>" + "Average price: $" + factsData[0].daily_total_value + "<br>" + "Population: " + factsData[0].population + "<br>" + "Metro: " + factsData[0].metro + "<br>" + "Rank: " + factsData[0].rank + "<br>" + "Currency: " + factsData[0].currency + "<br>"  + "Timezone: " + factsData[0].timezone  + "<br>" + "Airport: " + factsData[0].airport);
    }
